 ...
 * @author Sergio
 */
public class SeleccionDeUsuarioParaListarPrestamos extends javax.swing.JInternalFrame implements ActionListener,MouseListener {
    private int filaSeleccionada;
    private final AbstractTableModel modeloTabla;
    /**
     * Creates new form SeleccionDeUsuario
     */
    public SeleccionDeUsuarioParaListarPrestamos() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione el usuario para ver sus libros");
    ...
    private void abrirVentanaPrestamos(){  
        ...
        ListarPrestamosDeUsuario frame=new ListarPrestamosDeUsuario(Principal.getBiblioteca().getUsuarios().get(filaSeleccionada));
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"EL usuario Admin no tiene libros reservados","Error", JOptionPane.ERROR_MESSAGE);
        }
    }
