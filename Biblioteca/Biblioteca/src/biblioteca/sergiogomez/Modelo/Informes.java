...
public class Informes {
    public void carnet(Integer id) throws ClassNotFoundException{
        try {
    ...
    public void informeUsuariosLibros(){
        try {                                                 
            Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/biblioteca","root","");
            URL url= getClass().getResource("../informes/InformeLibrosBliblioteca.jasper");
            ...
            JRPdfExporter exporter = new JRPdfExporter();     
            exporter.setExporterInput(new SimpleExporterInput(jasperPrint)); 
            exporter.setExporterOutput(new SimpleOutputStreamExporterOutput(new java.io.File("informePDF.pdf")));
            exporter.exportReport();
