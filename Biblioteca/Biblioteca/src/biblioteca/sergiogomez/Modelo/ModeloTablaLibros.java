...
public class ModeloTablaLibros extends AbstractTableModel {
    ...
    public int getRowCount() {
        return Principal.getBiblioteca().getLibros().size();
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            case 0:
                obj=Principal.getBiblioteca().getLibros().get(rowIndex).getTitulo();
                break;
            case 1:
                obj=Principal.getBiblioteca().getLibros().get(rowIndex).getISBN();
                break;
        }
        return obj;
    }
